...
const UpdateProject = () => {
  ...
  const [otherStack, setOtherStack] = useState(""); // state for other stack input
  ...
  const handleUpdateProject = (e) => {
    ...
    formData.append("stack", stack === "Other" ? otherStack : stack); // use the other stack value
                  ...
                  <div className="mt-2">
                    ...
                    {stack === "Other" && (
                      <input
                        ...
                        placeholder="Enter your custom stack"
