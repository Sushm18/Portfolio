...
export const register = catchAsyncErrors(async (req, res, next) => {
  ...
  const user = await User.create({
    ...
    linkedInURL,
    avatar: {
      public_id: cloudinaryResponseForAvatar.public_id, // Corrected
      url: cloudinaryResponseForAvatar.secure_url,     // Corrected
    },
    resume: {
      public_id: cloudinaryResponseForResume.public_id, // Corrected
      url: cloudinaryResponseForResume.secure_url,     // Corrected
    },
  });
...
export const getUser = catchAsyncErrors(async (req, res, next) => {
  ...
  console.log("user detailsssssssssssssssssssss"+user)
  res.status(200).json({
    success: true,
    user,
  });
...
export const getUserForPortfolio = catchAsyncErrors(async (req, res, next) => {
  const id = "67552ae55e9c26ebb3a298f2";
